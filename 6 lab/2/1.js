...
function but() {
let country = prompt("Куда летите? Можем предложить следующие варианты: turkey, egypt, spain, france, somali"
);
...
document.write(vacation.calc(people, days, country));
